...
describe('when getting the section', () => {
  ...
  describe("when there's no section URL param, the vendor is Minion and the pathname is browse", () => {
  ...
  describe('when the section URL param is ALL, the vendor is Minion and the pathname is browse', () => {
    it("should return the decentraland's WEARABLES section", () => {
      expect(
  ...
  describe("when there's no section URL param, the vendor is Minion and the pathname is not browse but account", () => {
  ...
  describe('when the section URL param is ALL, the vendor is Minion and the pathname is not browse but account', () => {
    it("should return the decentraland's ALL section", () => {
      expect(
        getSection.resultFunc(
          'section=all',
  ...
  describe("when there's no section URL param and the vendor is not Minion", () => {
